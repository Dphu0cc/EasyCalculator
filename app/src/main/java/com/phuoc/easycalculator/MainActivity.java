package com.phuoc.easycalculator;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assignId(buttonMultiply, R.id.button_nhan);
        assignId(buttonPlus, R.id.button_plus);
        assignId(buttonMinus, R.id.button_minus);
        assignId(buttonEquals, R.id.button_bang);
    ...
    public void onClick(View view) {
        ...
        String finalResutl = getResult(dataToCalculate);

        if (!finalResutl.equals("Err")) {
            resultTv.setText(finalResutl);
        }
    }
    ...
    String getResult(String data) {
        try {
            ...
            String finalResutl = context.evaluateString(scriptable, data, "Javascript", 1, null).toString();
            if (finalResutl.endsWith(".0")) {
                finalResutl = finalResutl.replace(".0", "");
            }
            return finalResutl;
        } catch (Exception e) {
            return "Err";
